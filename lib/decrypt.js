...
var proceed = function(src, dst)
{
	...
	{
		console.log(chalk.red('Destination path was not found! Please make sure that the destination path is correct.'));
		return false;
	}
	...
	{
		console.log(chalk.red('Destination path must be a folder!'));
		return false;
	}
